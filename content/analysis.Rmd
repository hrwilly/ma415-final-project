...
payroll_hits %>%
  ...
  labs(x = "Payroll", y = "Total Hits", 
    title = "Relationship Between Total Hits and Payroll for 15 Positive Relationship Teams", color = "Year") +
  theme(strip.text.x = element_text(size = 12, face = "bold")) +
  theme(strip.background = element_rect(color = "black", fill = "#F0F8FF", size = 1, linetype = "solid"))
```
\
...
payroll_hruns %>%
  ...
  labs(x = "Payroll", y = "Total Homeruns", 
    title = "Relationship Between Total Homeruns and Payroll for 15 Positive Relationship Teams", color = "Year") +
  theme(strip.text.x = element_text(size = 12, face = "bold")) +
  theme(strip.background = element_rect(color = "black", fill = "#F0F8FF", size = 1, linetype = "solid"))
```
\
...
payroll_so %>%
  ...
  labs(x = "Payroll", y = "Total Strikeouts", 
    title = "Relationship Between Total Strikeouts and Payroll for 15 Positive Relationship Teams", color = "Year") +
  theme(strip.text.x = element_text(size = 12, face = "bold")) +
  theme(strip.background = element_rect(color = "black", fill = "#F0F8FF", size = 1, linetype = "solid"))
```
\
...
payroll_er %>%
  ...
  labs(x = "Payroll", y = "Total Earned Runs Against", 
    title = "Relationship Between Total Earned Runs and Payroll for 15 Positive Relationship Teams", color = "Year") +
  theme(strip.text.x = element_text(size = 12, face = "bold")) +
  theme(strip.background = element_rect(color = "black", fill = "#F0F8FF", size = 1, linetype = "solid"))
```
\
