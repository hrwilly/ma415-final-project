...
<<<<<<< HEAD
ggplot(combined)+geom_point(aes(log(payroll),win_perc,color=year))+facet_wrap(vars(h_name))+scale_color_viridis_c()
ggplot(combined)+geom_point(aes(log(payroll),win_perc,color=h_name))+facet_wrap(vars(year))
```
=======
...
>>>>>>> a72e6daecf8a94e1593cea4ffd80884414c9a9ec
