...
ggplot(combined)+geom_point(aes(payroll,win_perc,color=year))+facet_wrap(vars(h_name))+scale_color_viridis_c()
ggplot(combined)+geom_point(aes(payroll,win_perc,color=h_name))+facet_wrap(vars(year))
```