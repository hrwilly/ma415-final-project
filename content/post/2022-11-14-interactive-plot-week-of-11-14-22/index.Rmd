...
# someone pls save this data so we don't ahve to load it everytime :)
=======
<<<<<<< HEAD
#stadiums <- read_excel("/Users/hannahholbert/Documents/stadiums.xlsx")
...
#(table <- node  %>% html_text() %>% cat() %>% as_tibble())
...
#baseball_w_stadiums <- merge(baseball, stadiums, by.x=c("h_name"), 
 #                                                by.y =("homename")) 
=======
>>>>>>> 346ac7febb27096ea4731a62fa78368498e5d959
...
baseball_w_stadiums <- merge(baseball, stadiums, by.x=c("h_name"), 
                                                 by.y =("Abbreviation")) 
>>>>>>> 8b7538ac08d0ceac31f6331bb4bef1f30df39d5a
